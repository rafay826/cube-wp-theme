...
<!--
                <h1 class="call-now">CALL NOW!</h1>
                <h2 class="phone-number"><a href="tel:+1-310-795-4189">(310)-795-4189</a></h2>
-->
...
<!--
    <button id="nextpage" class="pt-trigger" data-animation="58-61" data-goto="-1">Go to next page</button>
    <button id="prevpage" class="pt-trigger" data-animation="58-61" data-goto="-2">Go to previous page</button>
-->
